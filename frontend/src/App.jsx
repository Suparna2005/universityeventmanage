  ...
  return (
    <main className="shell">
      ...
      <section className="hero" aria-labelledby="page-title">
        ...
        <aside className="signal"><p className="eyebrow">System signal</p><div className={`signal-dot ${connected ? "ready" : ""}`} /><h2>{health ? (connected ? "All systems ready" : "API online") : "Checking connection"}</h2><p>{health ? `API ${health.status}; database ${health.database}.` : error || "Connecting to the platform service."}</p></aside>
      </section>
